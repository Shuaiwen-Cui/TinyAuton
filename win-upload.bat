...
@REM git push -f https://github.com/Shuaiwen-Cui/TinyAuton.git main
git push -f https://github.com/Shuaiwen-Cui/TinyAuton.git main
@REM git remote add origin https://github.com/Shuaiwen-Cui/TinyAuton.git
