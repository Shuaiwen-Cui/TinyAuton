...
public:
    ...
    /**
     * @brief Propagate train / inference mode to all layers.
     *        Affects layers with running statistics (BatchNorm1D, BatchNorm2D).
     * @param mode  true → training, false → inference
     */
