...
public:
    ...
    /**
     * @brief Switch train / inference mode.
     *        Only meaningful for layers with running statistics (e.g. BatchNorm).
     *        Default is a no-op so all other layers are unaffected.
     */
    virtual void set_training(bool /*mode*/) {}
};
