...
{
    // Disable TWDT — AI training loops hold CPU for extended periods,
    // which is normal and expected. TWDT would falsely trigger.
    esp_task_wdt_deinit();
    printf("TWDT disabled for AI training workload\n");
